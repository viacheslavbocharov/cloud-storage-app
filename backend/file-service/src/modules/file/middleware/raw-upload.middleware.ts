...
export function rawUploadMiddleware(req: Request, res: Response, next: NextFunction) {
  ...
  busboy.on('file', (fieldname, file, info) => {
    ...
    const filename = typeof raw === 'string'
      ? raw
    ...
    const tempPath = path.join('./temp', storedName);
